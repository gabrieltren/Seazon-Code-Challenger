...
class ImovelViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = ImovelListSerializer
    ...
    def get_queryset(self):
        return Imovel.objects.filter(ativo=True).order_by("-criado_em")

    def get_serializer_class(self):
        serializer_map = {
            "list": ImovelListSerializer,
            "retrieve": ImovelRetriveSerializer,
            "create": ImovelCreateSerializer,
            "update": ImovelUpdateSerializer,
            "partial_update": ImovelUpdateSerializer,
        }
