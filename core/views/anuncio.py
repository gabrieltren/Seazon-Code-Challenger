...
from core.serializers.anuncio_serializers import (
    AnuncioListSerializer,
    AnuncioRetriveSerializer,
...
class AnuncioViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Anuncio.objects.all().order_by("-criado_em")

    def get_serializer_class(self):
        serializer_map = {
            "list": AnuncioListSerializer,
            "retrieve": AnuncioRetriveSerializer,
            "create": AnuncioCreateSerializer,
            "update": AnuncioUpdateSerializer,
            "partial_update": AnuncioUpdateSerializer,
        }
